...
const (
	...
	// RegionRaftPrefix We save two types region data in DB, for raft and other meta data.
	...
	// RaftLogSuffix Following are the suffix after the local prefix.
	// For region id
	RaftLogSuffix    byte = 0x01
	RaftStateSuffix  byte = 0x02
	ApplyStateSuffix byte = 0x03

	// RegionStateSuffix For region meta
...
var (
	...
	// PrepareBootstrapKey Following keys are all local keys, so the first byte must be 0x01.
